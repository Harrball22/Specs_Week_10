...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("We are in the middle of creating the cupcake menu. We currently have three cupcakes on the menu but we ned to decide on pricing");
        ...
        System.out.println("(Input a numerical number taken to 2 decimal places)");
